...
def tran_big_num(a):
    '''
    function:Converts data in OID larger than 128
    :param a: Big data in OID
    :return: Successfully converted data
    '''
    lst1 = []
    lst1.append(a % 128)
    if ((a - (a % 128)) / 128) < 128:
...
def oid_to_hex(testdata):
    '''
    function: Convert OID data base
    :param testdata: OID data in hexadecimal format
    :return: Hexadecimal OID data
    '''
    after_tran_oid = []
    first_level = int(testdata[0])*40 + int(testdata[1])
    after_tran_oid.append(first_level)
...
def tran_oid(list):
    '''
    function:OID data in decimal is converted to hexadecimal
    :param list: OID data in decimal notation
    :return: OID data in hexadecimal format
    '''
    # dec_lst = []
    finale_oid_hex_lst = []
    final_oid_lst = []
